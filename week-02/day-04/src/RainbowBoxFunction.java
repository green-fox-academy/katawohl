...
public class RainbowBoxFunction {
    public static void mainDraw(Graphics graphics) {
        ...
        // Create a loop that fills the canvas with rainbow colored squares (red, orange, yellow, green, blue,
        // indigo, violet).
        int size = 100;

        Color[] colorArray = new Color[]{Color.RED, Color.ORANGE, Color.YELLOW, Color.GREEN, Color.BLUE, new Color(75
                , 0,
