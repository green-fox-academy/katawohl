/*Create a few blog post objects:
    ...
    "One Engineer Is Trying to Get IBM to Reckon With Trump" titled by William Turton at "2017.03
    .28."
  ...
  public static void main(String[] args) {
    ...
    BlogPost post3 = new BlogPost("William Turton",
        ...
        "Daniel Hanley, a cybersecurity engineer at IBM, doesn’t want to be the center of " +
            "attention" +
            ".\n" +
            "    When I asked to take his picture outside one of IBM’s New York City offices, he " +
            "told" +
            " me that\n" +
            "    he wasn’t really into the whole organizer profile thing.",
        "2017.03.28.");

    System.out.println(post3.giveFullPost());
  }
}
